      ...
      <div className="grid md:grid-cols-2 gap-2">
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <button
              className="flex items-center justify-between gap-2 px-5 py-2.5 w-[50%] lg:w-[200px] bg-white text-black rounded-full text-sm font-bold"
      ...
      <div className="grid md:grid-cols-2 gap-2">
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <button
              className="flex items-center justify-between gap-2 px-5 py-2.5 w-[200px] bg-white text-black rounded-full text-sm font-bold"
              onClick={() => router.push("/preachers")}
            >
              Learn more
              <ArrowRight size={16} />
            </button>
  ...
  return (
    <div className="grid md:grid-cols-2 gap-10 xl:gap-[139px]">
      ...
      >
        <img
          src="/daily1.png"
          className="w-[326px] h-[284px] xl:w-[525px] xl:h-[456px]"
        />
      </div>
    </div>
  );

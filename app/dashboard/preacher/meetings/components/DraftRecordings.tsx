...
import { mockCourses, mockDraftRecordings } from "@/utils/dummyData";
import Input from "@/app/components/Input";
import Button from "@/app/components/Button";
import RecordingCard from "./RecordingCard";

const DraftRecordings = () => {
  ...
  return (
    <div className="bg-white mx-4 lg:mx-10 border border-[#E3E8EF] rounded-[16px]">
      <div className="flex items-center justify-between my-[21px] mx-6">
        <h2 className="text-lg font-semibold text-gray-900">Draft recording(3)</h2>
      ...
      {mockCourses.length < 1 ? (
        ...
        <div className="grid grid-cols-3 gap-5 p-6">
          {mockDraftRecordings?.map((recording) => (
      ...
      {/* Pagination */}
      {mockDraftRecordings.length > 0 && <div className="flex items-center justify-center gap-4 py-4 border-t border-gray-200">
...
export default DraftRecordings;

    ...
    <div className="bg-white mx-4 lg:mx-10 border border-[#E3E8EF] rounded-[16px]">
      <div className="flex flex-col lg:flex-row items-start lg:items-center gap-2 justify-between my-[21px] mx-6">
        <h2 className="text-lg font-semibold text-gray-900">
          Draft recordings
          <span className="ml-2 text-[#60666B] font-normal text-sm">(0)</span>
        </h2>
        <div className="flex items-center gap-3">
          <div className="relative">
            <Input
              type="text" id="dr-search" name="dr-search"
              onChange={() => {}} value=""
      ...
      <div className="flex justify-center h-[350px] items-center">
        <div className="flex flex-col gap-4 items-center text-center px-6">
          ...
          <p className="text-base font-semibold text-gray-700">No draft recordings</p>
          <p className="text-sm text-[#60666B]">Draft recordings will appear here once the feature is available.</p>
        </div>
      </div>
    </div>
  );

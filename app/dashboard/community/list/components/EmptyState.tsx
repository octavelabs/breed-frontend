...
export const EmptyState = () => (
  <div className="flex-1 flex flex-col items-center justify-center gap-4 text-center px-8 bg-white dark:bg-[#121316]">
    ...
    <p className="text-base font-semibold text-[#180426] dark:text-white">Select a community</p>

  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-sm mb-2">Select main topic</label>
          <Dropdown
            value={selectedTopic}
            options={topics}
            keySelector="name"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Message to mentor <span className="font-normal text-[#60666B]">(optional)</span>
          </label>
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 border border-[#60666B] rounded-lg text-base resize-none focus:outline-none focus:border-[#870BD6]"
          />
        </div>
      </div>
    </div>

          ...
          >
            ...
            >
              <div className="max-w-xl w-full">
                ...
                <h1 className="text-3xl md:text-4xl lg:text-[50px] font-[700] text-[#180426] mb-6 font-aeonik leading-tight">
                ...
                <div className="mt-8 md:mt-10 text-2xl md:text-3xl lg:text-4xl text-[#180426] italic font-mono">
                  Matthew 28:16-20
                </div>
              </div>
            </div>

...
export function BookingModal({
  ...
  useEffect(() => {
    if (!isOpen) return;
    mentorshipService
      .getMentorAvailability(mentorInfo.id)
        ...
        <div className="bg-white rounded-3xl max-w-md w-full p-8 text-center mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 mb-6">
              ...
              <span className="font-semibold text-[#870BD6]">
                {mentorInfo.name.split(" ")[0]}
              </span>
              .
              <br />
          ...
          <div className="mb-6">
            {mentorInfo.avatarUrl ? (
              <img
                ...
                alt={mentorInfo.name}
                className="w-20 h-20 rounded-full mx-auto mb-3 ring-4 ring-purple-100 object-cover"
              />
            ) : (
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex flex-col gap-4 w-full lg:w-1/2">
            ...
            {mentorInfo.specializations?.length ? (
              <div>
                <p className="text-sm lg:text-base text-[#60666B] mb-2">
                  Specializes in
                </p>
                <div className="flex flex-wrap gap-1.5">
                  {mentorInfo.specializations.map((s) => (
                    <span
                      key={s}
                      className="text-xs bg-[#F5EBFF] text-[#870BD6] px-2.5 py-1 rounded-full font-medium"
                    >
                      {s}
                    </span>
                  ))}
          ...
          <div className="w-full lg:w-1/2 -order-1 lg:order-0">
            <div className="mb-8 lg:mb-4">
              <p className="text-base text-[#60666B] mb-1">
            ...
            <button
              ...
              className={`w-full py-4 rounded-full font-medium transition-all flex items-center cursor-pointer justify-center gap-2 ${

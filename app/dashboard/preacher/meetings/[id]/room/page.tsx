...
export default function PreacherRoomRedirect() {
  ...
  return (
    <div className="fixed inset-0 bg-[#0D0427] flex flex-col items-center justify-center gap-4">
      <div className="w-16 h-16 rounded-full bg-gradient-to-b from-[#870BD6] to-[#5B26B1] flex items-center justify-center">
